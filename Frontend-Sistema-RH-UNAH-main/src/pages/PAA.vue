<template>
  <div class="d-flex m-5 justify-content-center">
    <form class="d-flex needs-validation">
      <select
        class="form-select w-auto optionBtn"
        aria-label="Seleccion de busqueda"
        required
      >
        <option selected disabled value="">Buscar por</option>
        <option value="1">ID empleado</option>
  ...
  <div class="d-flex card PerfilCard">
    ...
    <div
      class="d-flex"
      id="containerCardPerfil"
      about="AQUI VA LA FOTO DEL EMPLEADO"
    >
      <img
      ...
      <div
        ...
        about="Aqui va la informacion personal"
      >
      ...
      <div
        class=""
        style="padding-left: 5rem"
        about="Aqui va informacion universitaria"
      >
      ...
      <div
        class=""
        style="padding-left: 5rem"
        about="Aqui va informacion de los dias de PAA"
      >
  ...
  <div class="d-flex justify-content-left" style="padding-left: 5rem">
    <form class="d-flex needs-validation">
      ...
      >
        ...
        <option value="1">Todos</option>
        <option value="2">I PAC</option>
        <option value="3">II PAC</option>
        <option value="4">III PAC</option>
      </select>
      ...
      <select
        ...
        required
      >
        <option selected disabled value="">Funcion</option>
        <option value="1">Todos</option>
        <option value="2">Apoyo</option>
        <option value="3">Aplicador</option>
  ...
  <div
    ...
    style="padding-left: 4rem; padding-right: 4rem; margin-top: 2rem"
  >
    <table class="table align-middle mb-0 bg-white">
      <thead class="paa-table">
        <tr>
          <th scope="col">#</th>
          <th scope="col">ID</th>
      ...
      <tbody>
        <!-- <tr v-for="(Empleado, i) in Empleados" :key="i">
          ...
          <th scope="row">{{ i + 1 }}</th>
          <td about="AQUI VA EL ID DEL USUARIO">{{ Empleado.id_empleado }}</td>
            ...
            >
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">Info por decidir</div>
        ...
        <tr>
          ...
          <td about="AQUI VA LA IMAGEN, NOMBRE, Y CORREO">
            <div class="d-flex align-items-center">
              ...
              />
              <div class="ms-3">
                <p class="fw-bold mb-1">Mark Alfonso Zucaritas Rodriguez</p>
                <p class="text-muted mb-0">Mark@unah.com</p>
              </div>
            </div>
          </td>
  ...
  >
    ...
    <button
      type="button"
      class="btn btn-secondary btnTablas"
      id=""
      data-bs-toggle="modal"
      data-bs-target=""
    >
    ...
    <button
      type="button"
      class="btn btn-success btnTablas"
      data-bs-toggle="modal"
      data-bs-target="#agregarParticipantes"
    >
      Agregar
      <svg
        xmlns="http://www.w3.org/2000/svg"
    ...
    >
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="staticBackdropLabel">
              Formulario de participacion PAA
            </h1>
            <button
              type="button"
              class="btn-close"
            ...
            <div class="container">
              <form class="row mt-2 g-3 needs-validation" novalidate>
                <div class="col-sm-1">
                  ...
                  <div class="invalid-feedback">Llenar los campos.</div>
                </div>

                <div class="col-sm-2">
                  <label for="txt-participacion" class="form-label fw-bold"
                    >Participacion</label
                  >
                  <input
                    type="text"
                ...
                <div class="col-sm-1">
                  <label for="txt-dias" class="form-label fw-bold">Dias</label>
                  <input
                    type="number"
                    class="form-control"
                    id="txt-dias"
                ...
                <div class="col-sm-2">
                  <label for="txt-fechas" class="form-label fw-bold"
                    >Fechas</label
                  >
                  <input
                    type="date"
                ...
                <div class="col-sm-1">
                  <label for="txt-vigentes" class="form-label fw-bold"
                    >Vigentes</label
                  >
                  <input
                    type="text"
                ...
                <div class="col-sm-2">
                  <label for="txt-diasg" class="form-label row-center fw-bold"
                    >Dias gozados</label
                  >
                  <input
                    type="number"
                ...
                <div class="col-sm-2">
                  <label for="txt-oficio" class="form-label fw-bold"
                    >Oficio</label
                  >
                  <input
                    type="text"
                ...
                <div class="col-sm-2">
                  <label for="txt-fechaf" class="form-label fw-bold"
                    >Fecha final</label
                  >
                  <input
                    type="date"
                ...
                <div class="col-sm-2">
                  <label for="txt-proceso" class="form-label fw-bold"
                    >Proceso</label
                  >
                  <input
                    type="text"
                ...
                >
                  <select
                    ...
                    required
                  >
                    <option selected disabled value="" class="fw-bold">
                      Edificio
                    </option>
                    <option value="1">Todos</option>
                    <option value="2">B1</option>
                ...
                <div class="modal-footer">
                  ...
                  <!-- <button class="btn btn-primary" type="submit"  @click="NuevoRegistro()">Enviar</button> -->
                </div>
              </form>
            </div>
          </div>
