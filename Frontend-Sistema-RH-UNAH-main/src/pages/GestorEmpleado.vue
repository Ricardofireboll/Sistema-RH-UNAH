      ...
      try {
        await axios({
          ...
          .then((res) => {
            ...
            CorreoI.value = Empleado.value.at(0).correo_institucional;
            dni.value = Empleado.value.at(0).dni;
            Genero.value = Empleado.value.at(0).genero;
            fechai.value = Empleado.value.at(0).fecha_ingreso.slice(0, 10);
            Fechan.value = Empleado.value.at(0).fecha_nacimiento.slice(0, 10);
            Celular.value = Empleado.value.at(0).celular;
            CorreoP.value = Empleado.value.at(0).Correo_personal;
            Telefono.value = Empleado.value.at(0).telefono;
            Plan2.value = Empleado.value.at(0).plan2;
            Entrada.value = Empleado.value.at(0).entrada;
            Salida.value = Empleado.value.at(0).salida;
            CriterioX.value = Empleado.value.at(0).criterio_x;
            Anexo1.value = Empleado.value.at(0).anexo_1;
            Anexo1B.value = Empleado.value.at(0).anexo_1b;
            Folio.value = Empleado.value.at(0).folio;
            A14.value = Empleado.value.at(0).a14;
            Modalidad.value = Empleado.value.at(0).modalidad;
            RolT.value = Empleado.value.at(0).rol_trabajo;
            A15.value = Empleado.value.at(0).anexo_15;
            Dentrada.value = Empleado.value.at(0).d_entrada;
            Dsalida.value = Empleado.value.at(0).d_salida;
            EstadoC.value = Empleado.value.at(0).estado_civil;
            Sueldo.value = Empleado.value.at(0).sueldo;
          })
          .catch((error) => {
            console.log(error);
          });
