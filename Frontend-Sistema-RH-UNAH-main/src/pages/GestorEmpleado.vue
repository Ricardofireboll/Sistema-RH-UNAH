  ...
  <div class="float-right q-mb-xl">
    <div class="q-pa-md">
      ...
      <q-dialog v-model="dialog">
        <q-layout view="lhh LpR lff" container style="height: 700px" class="bg-grey-3">
          <q-header class="bg-black">
            <q-toolbar>
              <q-toolbar-title class="text-center">Registrar un nuevo empleado</q-toolbar-title>
            </q-toolbar>
          </q-header>
          <q-page-container>
            <div class="q-pa-md">
