<template>
  ...
  <q-dialog v-model="reporte" full-width>
          ...
          >
            <div>
              <img
                ...
                style="width: 15rem; margin-bottom: 3rem; padding-left: 1.5rem"
              />
              <img
                src="../assets/img/SDPE.png"
                style="width: 10rem; margin-bottom: 5.5rem; margin-left: 2rem"
              />
              <img
              ...
              <div>
                <p
                  ...
                  "
                >
                  CONSTANCIA CONDENSADA DE PARTICIPACION PROCESO PAA
                </p>
                <p
                  style="
                    text-align: justify;
                  ...
                  "
                >
                  La suscrita SECRETARIA EJECUTIVA DE DESARROLLO DE PERSONAL de
                  la Universidad Nacional Autonoma de Honduras; a traves del
                  Departamento de Efectivdad del Recurso Humano, hace constar
                  que el empleado abajo detallado ha particpado activamente en
                  los distintos procesos de aplicacion de la prueba de admision
                  PAA por lo que se reconoce su labor participativa en estos
                  procesos institucionales y para los fines que al mismo le
                  interesen y sean pertinentes, se le detallan los datos de sus
                  participaciones, comprendidas desde el año 2015 a la fecha:
                </p>
                <hr
                  style="
                    margin-right: 4rem;
          ...
          <div class="column-xs flex-column">
            ...
            >
              ...
              <q-input
                ...
                lazy-rules
                :rules="[
                  (val) => (val && val.length > 0) || 'No se agrego un nombre',
                ]"
              />
            </q-form>
...
export default {
  setup() {
    ...
    const buscarEmpleado = async () => {
      ...
      try {
        await axios({
          url: `/RR-HH/PAA/empleadosPAA/${Buscar.value}`,
          method: "get",
          responseType: "json",
        })
          .then((res) => {
